...
namespace ITStepShop.Migrations
{
    ...
    [Migration("20240314213408_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITStepShop.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITStepShop.Models.ShopUser", b =>
                {
            ...
            modelBuilder.Entity("ITStepShop.Models.Order", b =>
                {
                    b.HasOne("ITStepShop.Models.ShopUser", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ITStepShop.Models.Product", "Product")
                        .WithMany()
